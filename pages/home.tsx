...
import { MyQueue } from '../src/features/home/my-queue';
import { ReadingStreak } from '../src/features/home/reading-streak';
import { BorrowedBooks } from '../src/features/stacks/borrowed-books';
import { ReadyForPickup } from '../src/features/home/ready-for-pickup';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Your personal reading dashboard and library management hub" />
      </Head>
