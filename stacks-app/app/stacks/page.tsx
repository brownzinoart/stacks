        ...
        <div className="flex gap-4" style={{ width: "max-content" }}>
          {stacks.map((stack) => {
            ...
            return (
              <div
                key={stack.id}
                className="w-64 bg-white dark:bg-dark-secondary border-4 border-black dark:border-white shadow-brutal flex-shrink-0"
              >
                {/* Stack Image */}
                <div className="relative w-full aspect-square bg-gradient-accent flex items-center justify-center border-b-4 border-black dark:border-white">
                  ...
                  <div className="absolute bottom-2 left-2 right-2 flex justify-between items-end">
                    <div className="bg-black/80 border-2 border-white px-2 py-1">
      ...
      <div className="border-b-4 border-black dark:border-white bg-white dark:bg-dark-secondary">
        <div className="max-w-lg mx-auto px-4 py-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-gradient-primary border-4 border-black dark:border-white shadow-brutal-sm p-3 text-center">
            ...
            <div className="bg-gradient-accent border-4 border-black dark:border-white shadow-brutal-sm p-3 text-center">
            ...
            <div className="bg-gradient-success border-4 border-black dark:border-white shadow-brutal-sm p-3 text-center">
