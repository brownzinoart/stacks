...
export const mockReadingProgressEnhanced: ReadingProgressEnhanced[] = [
  ...
  // Fourth Wing - Currently reading - SLIGHTLY BEHIND (39% vs 42% ideal)
  {
    ...
    finishedDate: null,
    currentPage: 234, // 47% complete
    totalPages: 498,
    status: "reading",
    dailyCheckIns: [
      { date: new Date("2025-11-01"), pagesRead: 22, timeOfDay: "night" },
      { date: new Date("2025-11-02"), pagesRead: 20, timeOfDay: "evening" },
      { date: new Date("2025-11-04"), pagesRead: 18, timeOfDay: "night" },
      { date: new Date("2025-11-05"), pagesRead: 21, timeOfDay: "afternoon" },
      { date: new Date("2025-11-08"), pagesRead: 19, timeOfDay: "night" },
      { date: new Date("2025-11-10"), pagesRead: 23, timeOfDay: "evening" },
      { date: new Date("2025-11-12"), pagesRead: 20, timeOfDay: "afternoon" },
      { date: new Date("2025-11-15"), pagesRead: 19, timeOfDay: "night" },
      { date: new Date("2025-11-17"), pagesRead: 22, timeOfDay: "evening" },
      { date: new Date("2025-11-19"), pagesRead: 21, timeOfDay: "afternoon" },
      { date: new Date("2025-11-20"), pagesRead: 18, timeOfDay: "night" },
      { date: new Date("2025-11-21"), pagesRead: 19, timeOfDay: "evening" },
    ],
    _targetDate: new Date("2025-12-15"), // 44-day target, slightly behind at day 22
  } as any,
  // It Ends With Us - BEHIND (18% vs 25% ideal)
  {
    ...
    finishedDate: null,
    currentPage: 123, // 32% complete
    totalPages: 384,
    status: "reading",
    dailyCheckIns: [
      { date: new Date("2025-11-05"), pagesRead: 15, timeOfDay: "morning" },
      { date: new Date("2025-11-06"), pagesRead: 14, timeOfDay: "afternoon" },
      { date: new Date("2025-11-08"), pagesRead: 12, timeOfDay: "night" },
      { date: new Date("2025-11-10"), pagesRead: 13, timeOfDay: "afternoon" },
      { date: new Date("2025-11-12"), pagesRead: 11, timeOfDay: "evening" },
      { date: new Date("2025-11-14"), pagesRead: 14, timeOfDay: "night" },
      { date: new Date("2025-11-16"), pagesRead: 12, timeOfDay: "afternoon" },
      { date: new Date("2025-11-18"), pagesRead: 13, timeOfDay: "evening" },
      { date: new Date("2025-11-20"), pagesRead: 10, timeOfDay: "night" },
      { date: new Date("2025-11-22"), pagesRead: 9, timeOfDay: "afternoon" },
    ],
    _targetDate: new Date("2025-12-10"), // 35-day target, behind at day 18
  } as any,
  ...
  // A Court of Thorns and Roses - On a reading streak! (92%)
  {
    ...
    dailyCheckIns: [
      ...
      { date: new Date("2025-11-20"), pagesRead: 14, timeOfDay: "afternoon" },
      { date: new Date("2025-11-21"), pagesRead: 16, timeOfDay: "evening" },
      { date: new Date("2025-11-22"), pagesRead: 15, timeOfDay: "night" },
      { date: new Date("2025-11-23"), pagesRead: 12, timeOfDay: "afternoon" },
    ],
    _targetDate: new Date("2025-12-08"), // 30-day target, on track at day 15
  } as any,
